...
**Вариант 1 — установщик.** Скачайте `MoireRemover.exe` из
...
Не выбрана. Добавьте файл `LICENSE` на своё усмотрение — например, MIT,
если хотите свободное распространение и использование без ограничений.
